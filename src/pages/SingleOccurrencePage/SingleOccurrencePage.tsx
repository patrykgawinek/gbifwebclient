      ...
      <Container className={styles.tableBorderOverwrite}>
        {loading ? (
          ...
          <>
            ...
            <Table
              className={`mt-3 ${darkMode ? "table-dark" : undefined}`}
              striped
              hover
              size="sm"
            >
            ...
            <Row>
              {occurrence?.decimalLatitude !== undefined ? (
                <Col
                  className={
                    occurrence?.media.length > 0 ? "col-12 col-sm-12 col-md-6" : "col-sm-12"
                  }
                >
                  <div
                    className={occurrence?.media.length > 0 ? styles.leaflet : styles.onlyLeaflet}
                  >
                    {darkMode && (
                      <LeafletMap
